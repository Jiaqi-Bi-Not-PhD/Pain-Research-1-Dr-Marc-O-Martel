...
ggplot() +
  geom_line(data = new_data, aes(x = IndexLev1_Catastrophizing_Total, y = predicted, group = ID), color = "grey") +
...
ggplot() +
  geom_line(data = new_data, aes(x = IndexLev1_PositiveAffect_Total, y = predicted, group = ID), color = "grey") +
...
ggplot() +
  geom_line(data = new_data, aes(x = IndexLev1_NegativeAffect_Total, y = predicted, group = ID), color = "grey") +
  geom_line(data = average_predictions, aes(x = IndexLev1_NegativeAffect_Total, y = mean_predicted), color = "black", size = 1) +
