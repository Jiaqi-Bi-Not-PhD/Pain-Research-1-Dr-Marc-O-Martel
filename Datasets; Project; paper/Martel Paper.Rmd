...
## Outcome IndexLev1_PainAverage
model_ppth_pain <- lmer(IndexLev1_PainAverage ~ IndexLev2_QST_BaselinePPTh + (1|ID), data = data_paper2)
summary(model_ppth_pain)
model_TSP_pain <- lmer(IndexLev1_PainAverage ~ IndexLev2_QST_TSPAve + (1|ID), data = data_paper2)
summary(model_TSP_pain) #*
model_CPM_pain <- lmer(IndexLev1_PainAverage ~ IndexLev2_QST_CpmTrialAve + (1|ID), data = data_paper2)
summary(model_CPM_pain)

model_TSP_pain2 <- lmer(IndexLev1_PainAverage ~ IndexLev2_QST_TSPAve + IndexLev1_Catastrophizing_Total + Level1_Even_PhysActiv + (1|ID), data = data_paper2)
summary(model_TSP_pain2) #*

model_PPTh_pain2 <- lmer(IndexLev1_PainAverage ~ IndexLev2_QST_BaselinePPTh + IndexLev1_Catastrophizing_Total + Level1_Even_PhysActiv + (1|ID), data = data_paper2)
summary(model_PPTh_pain2)
