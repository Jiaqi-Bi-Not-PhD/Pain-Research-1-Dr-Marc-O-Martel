...
ggplot() +
  geom_line(data = new_data, aes(x = IndexLev1_NegativeAffect_Total, y = predicted, group = ID), 
            color = "grey", linetype = "dashed") +
...
ggplot(data_paper, aes(x = IndexLev2_QST_BaselinePPTh)) + 
...
ggplot(data_paper, aes(x = IndexLev2_QST_TSPAve)) + 
  geom_histogram(aes(y=..density..), color = "black", fill = "white") +
...
ggplot(data_paper, aes(x = IndexLev2_QST_CpmTrialAve)) + 
  geom_histogram(aes(y=..density..), color = "black", fill = "white") +
